...
import (
	...
	"github.com/livekit/mediatransportutil/pkg/audio/g711"
	"github.com/livekit/mediatransportutil/pkg/audio/g722"
	"github.com/livekit/mediatransportutil/pkg/audio/rtp"
	. "github.com/livekit/mediatransportutil/pkg/audio/sdp"
	"github.com/livekit/mediatransportutil/pkg/audio/srtp"
)
...
func TestSDPMediaOffer(t *testing.T) {
	...
	audio.CodecSetEnabled(g722.SDPName, false)
	defer audio.CodecSetEnabled(g722.SDPName, true)
