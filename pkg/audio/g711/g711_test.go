...
func testLaw[T ~[]byte, P interface {
	*T
	Decode() audio.PCM16Sample
	Encode(data audio.PCM16Sample)
}](t *testing.T, path, name string, src audio.PCM16Sample) {
...
func readPCM16(t testing.TB, path string) audio.PCM16Sample {
