...
func Decode(w audio.PCM16Writer, channels int, logger logger.Logger) (Writer, error) {
...
func Encode(w Writer, channels int, logger logger.Logger) (audio.PCM16Writer, error) {
...
func NewWebmWriter(w io.WriteCloser, sampleRate int, sampleDur time.Duration) audio.WriteCloser[Sample] {
