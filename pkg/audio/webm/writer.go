...
func NewPCM16Writer(w io.WriteCloser, sampleRate int, sampleDur time.Duration) audio.PCM16Writer {
	return NewWriter[audio.PCM16Sample](w, "A_PCM/INT/LIT", 1, sampleRate, sampleDur)
}

func NewWriter[T audio.Frame](w io.WriteCloser, codec string, channels, sampleRate int, sampleDur time.Duration) audio.WriteCloser[T] {
...
type writer[T audio.Frame] struct {
	codec      string
