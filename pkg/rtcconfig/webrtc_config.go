...
func NewWebRTCConfig(rtcConf *RTCConfig, externalIP string, development bool) (*WebRTCConfig, error) {
	...
	if externalIP != "" && (rtcConf.UseExternalIP || (rtcConf.NodeIP != "" && !rtcConf.NodeIPAutoGenerated)) {
